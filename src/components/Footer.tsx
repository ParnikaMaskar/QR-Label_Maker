        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/qr-maker" className="hover:text-foreground transition-colors">QR Generator</Link></li>
              <li><Link to="/label-maker" className="hover:text-foreground transition-colors">Label Maker</Link></li>
